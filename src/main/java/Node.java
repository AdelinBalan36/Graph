...
public class Node
{
    ...
    public void drawNode(Graphics g, int node_diam)
    {
       ...
       // g.setFont(new Font("TimesRoman", Font.BOLD, 15));
        ...
        if(number < 10)
            g.drawString(((Integer)number).toString(), coordX-node_diam/2+5, coordY+node_diam/2-5);
        else
            g.drawString(((Integer)number).toString(), coordX-node_diam/2+2, coordY+node_diam/2-5);
    }
}
